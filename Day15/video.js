...
function getVideo() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://theaudiodb.com/api/v1/json/1/mvid.php?i=112024")];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    console.log(data);
                    html = "";
                    data.mvids.forEach(function (response) {
                        var url = response.strMusicVid.split("v=")[1];
                        console.log(url);
                        html +=
